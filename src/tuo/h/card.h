...
public:
    ...
    void add_skill(Skill::Trigger trigger, Skill::Skill id, unsigned x, Faction::Faction y, unsigned n, unsigned c, Skill::Skill s, Skill::Skill s2 = Skill::no_skill, bool all = false, unsigned card_id = 0);
